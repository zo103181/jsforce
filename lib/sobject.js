...
/**
 * Describe layout information for SObject by recordTypeId
 *
 * @param {String} [recordTypeId] - Id of RecordType layout.
 * @param {Callback.<LayoutInfo>} [callback] - Callback function
 * @returns {Promise.<LayoutInfo>}
 */
SObject.prototype.layout = function(recordTypeId, callback) {
  var url = "/sobjects/" + this.type + "/describe/layouts/" + recordTypeId);
